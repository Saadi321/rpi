      ...
      <div className="max-w-6xl mx-auto">
        ...
        {!isSuccess && (
          <div className="flex flex-col md:flex-row md:items-center justify-between my-8 gap-4">
            <h2 className="text-2xl font-semibold text-slate-600 hover:text-secondary transition-colors tracking-wide w-fit cursor-pointer">
              Rawalpindi Polytechnic Institute
            </h2>
            ...
            <div className="text-right">
              ...
              <p className="text-sm text-slate-500 font-medium">Session 2025 - 2028 • <span className="text-secondary">Open Merit Based</span></p>
            </div>
          </div>
        )}
              ...
              <nav className="space-y-2 sticky top-8">
                {STEPS.map((s) => {
                  ...
                  return (
                    <div
                      key={s.id}
                      className={`flex items-center gap-3 p-3 rounded-xl transition-all duration-300 border ${isActive
                    ...
                    >
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-bold transition-colors ${isActive
